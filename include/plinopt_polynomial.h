...
template<typename Ring> using PRing = LinBox::PolynomialRing<Ring>;
#  else
// PolynomialRing with reading interface matching the writing one

template<typename Ring> class PRing : public LinBox::PolynomialRing<Ring> {
    typedef LinBox::PolynomialRing<Ring> Parent_t;
public:
